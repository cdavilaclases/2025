...
public class AnalisisSintactico extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\010\000\010\002\uffff\004\010\005\006\001\002\000" +
    "\010\002\ufffd\004\ufffd\005\ufffd\001\002\000\004\002\012" +
    "\001\002\000\010\002\ufffb\004\ufffb\005\ufffb\001\002\000" +
    "\010\002\000\004\010\005\006\001\002\000\010\002\ufffc" +
  ...
  public final java_cup.runtime.Symbol CUP$AnalisisSintactico$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$AnalisisSintactico$act_num)
		...
		Integer l = (Integer)((java_cup.runtime.Symbol) CUP$AnalisisSintactico$stack.peek()).value;
		 RESULT = 2*s + l; 
              CUP$AnalisisSintactico$result = parser.getSymbolFactory().newSymbol("S",2, ((java_cup.runtime.Symbol)CUP$AnalisisSintactico$stack.elementAt(CUP$AnalisisSintactico$top-1)), ((java_cup.runtime.Symbol)CUP$AnalisisSintactico$stack.peek()), RESULT);
            }
          return CUP$AnalisisSintactico$result;
		...
		Integer l = (Integer)((java_cup.runtime.Symbol) CUP$AnalisisSintactico$stack.peek()).value;
		 RESULT = l; 
              CUP$AnalisisSintactico$result = parser.getSymbolFactory().newSymbol("S",2, ((java_cup.runtime.Symbol)CUP$AnalisisSintactico$stack.peek()), ((java_cup.runtime.Symbol)CUP$AnalisisSintactico$stack.peek()), RESULT);
            }
          return CUP$AnalisisSintactico$result;
